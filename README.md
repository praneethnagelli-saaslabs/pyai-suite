...
| **Simulator** | Live voice call + adversarial tests | **Live call**, **Persona**, eval **Dashboard** / **Compare**, **Run stress test** |
...
5. **Simulator** → Start simulation or Persona → scorecard → Dashboard / Compare, or Run stress test
...
| **Scrib** | Hold **Control+Shift+1** (⌃, not ⌘), speak, release to paste. Hold again and say “shorter” to rewrite in place. |
